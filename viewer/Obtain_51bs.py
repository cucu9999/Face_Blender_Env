...
if __name__ == '__main__':
    ...
    num_columns = (num_blendshapes + max_lines - 1) // max_lines  # 置顶


    col_width = frame_width // num_columns # 行宽
    ...
    while True:
        ...
        cv2.imshow('Mediapipe Blendshape Live', frame)
