...
left_blink = Servo(12, 90, 145, 60, 11.1, 0, 90)      # 左眨眼
left_smile = Servo(13, 90, 130, 85, 11.1, 0, 90)      # 左微笑
left_eye_erect = Servo(14, 90, 120, 60, 11.1, 0, 90)  # 左眼竖
left_eye_level = Servo(15, 90, 120, 60, 11.1, 0, 90)  # 左眼平
left_eyebrow = Servo(0, 90, 140, 40, 11.1, 0, 90)    # 左眉毛

right_blink = Servo(7, 90, 120, 35, 11.1, 0, 90)     # 右眨眼
right_smile = Servo(6, 90,  95, 50, 11.1, 0, 90)      # 右微笑
right_eye_erect = Servo(5, 90, 120, 60, 11.1, 0, 90) # 右眼竖//
right_eye_level = Servo(4, 90, 120, 60, 11.1, 0, 90) # 右眼平//
right_eyebrow = Servo(8, 90, 140, 40, 11.1, 0, 90)   # 右眉毛

head_dian = Servo(1, 90,  160, 20, 11.1, 0, 90) # 点头
head_yao = Servo(2, 90, 160, 20, 11.1, 0, 90)  # 摇头 85
head_bai = Servo(10, 90,  160, 20, 11.1, 0, 90)  # 摆头85

mouth = Servo(9, 65, 135, 60, 11.1, 0, 65) # 嘴巴
...
if __name__ == '__main__':
    ...
    left_blink      = [ 89, 50]# 左眨眼 
    left_smile      = [ 90, 50]# 左微笑
    left_eye_erect  = [ 90, 50]# 左眼竖
    left_eye_level  = [ 89, 50]# 左眼平
    left_eyebrow    = [ 91, 50]# 左眉毛

    right_blink     = [ 90, 50]# 右眨眼
    right_smile     = [ 90, 50]# 右微笑
    right_eye_erect = [ 90, 50]# 右眼竖
    right_eye_level = [ 89, 50]# 右眼平
